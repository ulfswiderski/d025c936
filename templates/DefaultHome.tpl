...
{block name=title}D025C936 | Home{/block}
...
{block name=container}
	...
	<div class="container">
		...
		<div class="hero-unit">
			...
			Running on Phreeze {$PHREEZE_VERSION}{if ($PHREEZE_PHAR)} ({$PHREEZE_PHAR|basename}){/if}.</em></p>
		...
		<footer>
			<p>&copy; {$smarty.now|date_format:'%Y'} D025C936</p>
		</footer>
