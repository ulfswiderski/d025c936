...
require_once("DAO/PackageCriteriaDAO.php");

/**
 * The PackageCriteria class extends PackageDAOCriteria and is used
 ...
 * @version 1.0
 */
class PackageCriteria extends PackageCriteriaDAO
{
