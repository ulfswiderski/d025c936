...
require_once("DAO/ServiceCriteriaDAO.php");

/**
 * The ServiceCriteria class extends ServiceDAOCriteria and is used
 ...
 * @version 1.0
 */
class ServiceCriteria extends ServiceCriteriaDAO
{
