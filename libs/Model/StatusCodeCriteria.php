...
require_once("DAO/StatusCodeCriteriaDAO.php");

/**
 * The StatusCodeCriteria class extends StatusCodeDAOCriteria and is used
 ...
 * @version 1.0
 */
class StatusCodeCriteria extends StatusCodeCriteriaDAO
{
