...
require_once("DAO/PurchaseCriteriaDAO.php");

/**
 * The PurchaseCriteria class extends PurchaseDAOCriteria and is used
 ...
 * @version 1.0
 */
class PurchaseCriteria extends PurchaseCriteriaDAO
{
